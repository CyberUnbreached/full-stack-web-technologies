...
// Insert inputted data into database
...
// Execute the query or die with the error
$dblink->query($sql) or
    die("<h2>Something went wrong with:<br>$sql<br>" . $dblink->error . "</h2>");

echo "<h2>Data successfully entered into the database!</h2><hr>";
...
echo '<br><a href="index.php?page=contact" class="btn btn-primary">Back to Form</a>';
}
?>
</div>